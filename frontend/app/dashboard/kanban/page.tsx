...
//         setTasks(fetchedTasks); // Only set tasks after successful fetch

//         setData(cardsData); // Set the card data here after tasks are fetched
//       } catch (error) {
//         console.error("Error fetching tasks:", error);
//       }
//     };
...
//       <h1 className="text-center mt-8 mb-3 font-bold text-[25px]">Drag and Drop Application</h1>
//       <div className="flex gap-4 justify-between my-20 mx-4 flex-col lg:flex-row">
//         {data.length > 0 ? ( // Render only when data is available
//           data.map((val) => (
...
//           ))
//         ) : (
//           <p>Loading...</p> // Show a loading message if data is not yet fetched
//         )}
//       </div>
//     </DndContext>
//   );
